...
#include "../../tests/widgets/MediaList.h"
...
const QMetaObject MediaList::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MediaList.data,
      qt_meta_data_MediaList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MediaList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MediaList.stringdata0))
        return static_cast<void*>(const_cast< MediaList*>(this));
